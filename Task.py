...
def f22(number) -> str:
    ...
    a = number & 0b00000000000000000001111111111111
    b = number & 0b00000000000001111110000000000000
    c = number & 0b01111111111110000000000000000000
    d = number & 0b10000000000000000000000000000000
...
#############################################################################
print (f22(91))
print (f22(0x5ed20950))
print (f21(input_list=('1969', '2020', '1976', '1993')))
print (f12(180))
print (f22(0x5ed20950))
